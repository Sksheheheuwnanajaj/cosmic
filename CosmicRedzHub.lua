...
local u616 = loadstring(game:HttpGet('https://raw.githubusercontent.com/farehamhz/RedzLib/main/RedzLib'))():MakeWindow({
    ...
    SubTitle = 'discord.gg/SexKW4Fq5Z  •  COSMIC v2.1',
...
_ImageButton.BackgroundColor3 = Color3.fromRGB(10, 0, 24)
...
-- Cosmic gradient on button bg
local _BtnGrad = Instance.new('UIGradient')
_BtnGrad.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(22, 0, 50)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(8,  0, 20)),
})
_BtnGrad.Rotation = 135
_BtnGrad.Parent = _ImageButton

-- Neon glow stroke
local _BtnStroke = Instance.new('UIStroke')
_BtnStroke.Color = Color3.fromRGB(178, 0, 255)
_BtnStroke.Thickness = 2
_BtnStroke.Transparency = 0.1
_BtnStroke.Parent = _ImageButton

-- Pulsing stroke animation
task.spawn(function()
    local ts2 = game:GetService('TweenService')
    while _ImageButton and _ImageButton.Parent do
        ts2:Create(_BtnStroke, TweenInfo.new(1.4, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
