...
-- ╔══════════════════════════════════════╗
-- ║  COSMIC REDZ HUB  •  WindUI Edition  ║
-- ╚══════════════════════════════════════╝
local WindUI = loadstring(game:HttpGet('https://raw.githubusercontent.com/Footagesus/WindUI/main/dist/main.lua'))()

local _WindWindow = WindUI:CreateWindow({
    Title   = '✦ COSMIC REDZ HUB ✦',
    Icon    = 'star',
    Author  = 'discord.gg/SexKW4Fq5Z  •  COSMIC v2.1',
    Folder  = 'Redz | redz lib v5',
...
local u616 = {}
u616._win = _WindWindow

function u616.MakeTab(_, args)
    local _tab = _WindWindow:CreateTab({ Title = args[1] or 'Tab', Icon = args[2] or '' })
    local _obj = {}
    ...
    function _obj:AddSlider(a)
        _tab:CreateSlider({
            Title       = a.Title or a.Name or '',
            Description = a.Description or '',
            Default     = a.Default or a.Min or 0,
            Min         = a.Min or 0,
            Max         = a.Max or 100,
            Suffix      = a.Suffix or '',
            Callback    = a.Callback or function() end,
...
function u616:Minimize(state)
    if state then _WindWindow:Minimize() else _WindWindow:Restore() end
end
-- ★ Cosmic watermark bar
